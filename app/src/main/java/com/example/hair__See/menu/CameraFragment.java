...
public class CameraFragment extends Fragment implements MainActivity.OnBackPressedListener{
    ...
    private View view;
    public ImageView camnextBt,picksex1,picksex2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        sexChoice1.setOnClickListener(new OnSingleClickListener() {
            ...
            public void onSingleClick(View v) {
                sexChoice = 1;
                picksex1.setVisibility(View.VISIBLE);
                picksex2.setVisibility(View.GONE);
            }
        });
        sexChoice2.setOnClickListener(new OnSingleClickListener() {
            ...
            public void onSingleClick(View v) {
                sexChoice = 2;
                picksex1.setVisibility(View.GONE);
                picksex2.setVisibility(View.VISIBLE);
            }
        });
